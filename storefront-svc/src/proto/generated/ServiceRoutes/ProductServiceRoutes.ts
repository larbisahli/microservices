...
export interface ProductServiceRoutesClient extends grpc.Client {
  ...
  product(argument: _product_ProductResponse, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_product_ProductResponse__Output>): grpc.ClientUnaryCall;
  product(argument: _product_ProductResponse, metadata: grpc.Metadata, callback: grpc.requestCallback<_product_ProductResponse__Output>): grpc.ClientUnaryCall;
  product(argument: _product_ProductResponse, options: grpc.CallOptions, callback: grpc.requestCallback<_product_ProductResponse__Output>): grpc.ClientUnaryCall;
  product(argument: _product_ProductResponse, callback: grpc.requestCallback<_product_ProductResponse__Output>): grpc.ClientUnaryCall;
  product(argument: _product_ProductResponse, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_product_ProductResponse__Output>): grpc.ClientUnaryCall;
  product(argument: _product_ProductResponse, metadata: grpc.Metadata, callback: grpc.requestCallback<_product_ProductResponse__Output>): grpc.ClientUnaryCall;
  product(argument: _product_ProductResponse, options: grpc.CallOptions, callback: grpc.requestCallback<_product_ProductResponse__Output>): grpc.ClientUnaryCall;
  product(argument: _product_ProductResponse, callback: grpc.requestCallback<_product_ProductResponse__Output>): grpc.ClientUnaryCall;
...
export interface ProductServiceRoutesHandlers extends grpc.UntypedServiceImplementation {
  ...
  product: grpc.handleUnaryCall<_product_ProductResponse__Output, _product_ProductResponse>;
...
export interface ProductServiceRoutesDefinition extends grpc.ServiceDefinition {
  ...
  product: MethodDefinition<_product_ProductResponse, _product_ProductResponse, _product_ProductResponse__Output, _product_ProductResponse__Output>
}
