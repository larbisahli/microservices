...
import type { Currency as _commons_Currency, Currency__Output as _commons_Currency__Output } from '../commons/Currency';
import type { Language as _language_Language, Language__Output as _language_Language__Output } from '../language/Language';
import type { GoogleAnalytics as _commons_GoogleAnalytics, GoogleAnalytics__Output as _commons_GoogleAnalytics__Output } from '../commons/GoogleAnalytics';
import type { Social as _commons_Social, Social__Output as _commons_Social__Output } from '../commons/Social';
import type { Seo as _commons_Seo, Seo__Output as _commons_Seo__Output } from '../commons/Seo';
import type { Tax as _tax_Tax, Tax__Output as _tax_Tax__Output } from '../tax/Tax';
